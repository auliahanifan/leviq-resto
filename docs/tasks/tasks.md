...
- [ ] 1.1 Tabel `settings` (PIN kasir tunggal, tersimpan aman/hash)
...
- [ ] 1.7 Review relasi & constraint dasar (foreign key, enum status)
- [ ] 1.8 Verifikasi: migrasi berjalan tanpa error di Supabase, seed data dummy untuk testing
